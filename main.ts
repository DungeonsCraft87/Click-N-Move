controller.player4.onButtonEvent(ControllerButton.Up, ControllerButtonEvent.Pressed, function on_player4_button_up_pressed() {
...
controller.player4.onEvent(ControllerEvent.Connected, function on_player4_connected() {
    ...
    mp.setPlayerSprite(mp.playerSelector(mp.PlayerNumber.Four), sprites.create(img`
                . . . . . . . . . . . . . . . . 
                        ...
                        . . . . . . . . . . . . . . . .
            `, SpriteKind.Player))
    animation.runImageAnimation(mySprite4, [img`
                ....ffffff.........ccc..
                        ....ff22ccf.......cc4f..
                        .....ffccccfff...cc44f..
                        ....cc24442222cccc442f..
...
controller.player1.onButtonEvent(ControllerButton.Up, ControllerButtonEvent.Pressed, function on_player1_button_up_pressed() {
    statusbar.value += 0.05
})
statusbars.onStatusReached(StatusBarKind.Energy, statusbars.StatusComparison.GT, statusbars.ComparisonType.Percentage, 100, function on_status_reached_comparison_gt_type_percentage(status: StatusBarSprite) {
...
controller.player4.onButtonEvent(ControllerButton.Down, ControllerButtonEvent.Pressed, function on_player4_button_down_pressed() {
    statusbar.value += 0.05
})
...
statusbars.onStatusReached(StatusBarKind.EnemyHealth, statusbars.StatusComparison.GT, statusbars.ComparisonType.Percentage, 100, function on_status_reached_comparison_gt_type_percentage2(status2: StatusBarSprite) {
...
statusbars.onStatusReached(StatusBarKind.Magic, statusbars.StatusComparison.GT, statusbars.ComparisonType.Percentage, 100, function on_status_reached_comparison_gt_type_percentage3(status3: StatusBarSprite) {
...
statusbars.onStatusReached(StatusBarKind.Health, statusbars.StatusComparison.GT, statusbars.ComparisonType.Percentage, 100, function on_status_reached_comparison_gt_type_percentage4(status4: StatusBarSprite) {
...
controller.player1.onButtonEvent(ControllerButton.Down, ControllerButtonEvent.Pressed, function on_player1_button_down_pressed() {
    statusbar.value += 0.05
})
